...
> ⚠️ **2026-07-02 (R52): GitHub account transfer prep.** Both repos (`hubble-wms`, `hubble-wms-backups`) are moving to a new GitHub account (Supabase unchanged). Pages URLs do **not** redirect — the app URL becomes `https://<new-account>.github.io/hubble-wms/`, and the Supabase Site/Redirect URLs must be updated at transfer time. Full checklist: [REPO_TRANSFER_CHECKLIST.md](REPO_TRANSFER_CHECKLIST.md).
>
